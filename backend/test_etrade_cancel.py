"""Full ground-truth test against 33000009259.pdf
(Format 6 — ETRADE Cancellation of Request for Credit)."""
from pathlib import Path

from app.extractors import parse_document, read_document
from app.models import DocumentType

PDF = Path(r"c:\Users\Inno\Downloads\Cancellation Request for Credit\Cancellation Request for Credit\33000009259.pdf")

EXPECTED = {
    "document_type": DocumentType.credit_note,
    "header": {
        "credit_note_number": "HRCN2025-27534",
        "credit_note_date": "21-Nov-2025",
        "document_number": "HRCN2025-27534",
        "document_date": "21-Nov-2025",
        "system_ref_no": "33000009259",
        "rma_number": "",
        ...
        "irn": "",
        "currency": "INR",
        "original_invoice_number": "31000190633",
        "original_invoice_date": "13-NOV-2025",
        "invoice_number": "",
        "invoice_date": "",
        "debit_note_number": "",
        "debit_note_date": "",
