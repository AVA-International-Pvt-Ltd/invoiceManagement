"""Full ground-truth test against 31000196092.pdf
(Format 7 — ETRADE Request for Credit)."""
...
EXPECTED = {
    "document_type": DocumentType.r4c,
    "header": {
        "debit_note_number": "KADN2025-11793",
        "debit_note_date": "23-Nov-2025",
        "document_number": "KADN2025-11793",
        "document_date": "23-Nov-2025",
        "system_ref_no": "31000196092",
        "rma_number": "",
...
def main() -> None:
    ...
    for i, it in enumerate(items, 1):
        print(f"  {i}: Sl={it.system_ref_no!r}  ASIN={it.asin!r}  PO={it.combo!r}  inv_no={it.invoice_no!r}  qty={it.quantity}  total={it.total_amount}")
